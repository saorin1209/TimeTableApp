...
class Edit2: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func tappedButton(_ sender: UIButton) {
        ...
        let classData = Class(className:classTextField.text!, roomName: roomTextField.text!, cellNumber: ViewController2.cellNumber)
        ViewController2.testArray2.insert(classData, at: 0)
        
        //        保存
        UserDefaults.standard.set(NSKeyedArchiver.archivedData(withRootObject: ViewController2.testArray2), forKey: "TimeTable2")
